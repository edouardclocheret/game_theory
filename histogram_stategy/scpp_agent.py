...
class SCPPAgent(SimultaneousAuctionAgent):
    ...
    def get_bids(self):
        ...
        other_raw_bid = self.game_report.game_history['opp_bid_history'][-1]
        ##TODO
        return bids
    ...
    def update(self):        
        ...
        for good in self.goods:
            predicted_prices[good] = expected_local_bid(self.goods,self.valuation_function, self.curr_distribution,1000,500)
        ...
        if predicted_prices:
            ...
            if self.simulation_count % self.NUM_SIMULATIONS_PER_ITERATION == 0:
                ...
                self.curr_distribution.__init__()
